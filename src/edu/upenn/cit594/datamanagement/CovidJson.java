    ...
    public ArrayList<Covid> getCovidList() throws IOException {
        ...
        try {
            ...
            for (int i=0; i <jArray.size(); ++i){
                ...
                try {time = obj.get("etl_timestamp").toString().substring(0,10);} catch (Exception e) {time = null;}
                try {date = obj.get("etl_timestamp").toString().substring(11,obj.get("etl_timestamp").toString().length());} catch (Exception e) {date = null;}
